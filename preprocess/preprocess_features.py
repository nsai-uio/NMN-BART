...
def main():
    ...
    parser.add_argument('--output_h5', default='data/test2014_feature.h5')
    parser.add_argument('--input_tsv_folder', default='data/test2014_36', help='path to trainval_36 or test2015_36')
    ...
    path = args.output_h5
    hf = h5py.File(path, 'w', libver='latest')
    with hf as fd:
